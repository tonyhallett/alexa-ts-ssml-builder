...
type ExcludeBuilderMethod<
  TFrom extends AllBuilderMethods,
  TExclude extends AllBuilderMethods
> = Exclude<TFrom, TExclude>;
type ExcludeFromAllBuilderMethods<TExclude extends AllBuilderMethods> =
  ExcludeBuilderMethod<AllBuilderMethods, TExclude>;

// Note that do not need to specify text
const domainMethodsNames = [
  "fun",
  "longForm",
  "music",
  "news",
...
export type EmotionBuilderMethods = ExcludeFromAllBuilderMethods<
  | "sayAsInterjection"
  | EmphasisMethodNames
  | ProsodyPitchMethodNames
  | VoiceMethodNames
...
export type ConversationalBuilderMethods =
  (typeof conversationalBuilderMethods)[number];
...
export type EmphasisBuilderMethods = ExcludeFromAllBuilderMethods<
  "paragraph" | "sentence" | "emotion" | DomainMethodNames
>;

export type SentenceBuilderMethods = Exclude<
...
export type ProsodyPitchBuilderMethods = ExcludeBuilderMethod<
  ProsodySafeBuilderMethods,
  "emotion" | DomainMethodNames
>;
