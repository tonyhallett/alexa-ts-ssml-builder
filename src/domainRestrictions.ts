...
import { AllVoiceNames, Amy, Joanna, LangLocale, Lupe, Matthew, Takumi } from "./voices";

export const skillLocaleVoiceDependentBuilderMethods = ["conversational","news"] as const satisfies Readonly<AllBuilderMethods[]>;
type SkillLocaleVoiceDependentBuilderMethods = typeof skillLocaleVoiceDependentBuilderMethods[number];
...
export type VoiceLocaleExclusions<TVoice extends VoiceNamesOrDefault,TSkillLocale extends LangLocale> =
    ...
    keyof {
        ...
        [Property in keyof SkillLocaleVoiceDependentLookup as TSkillLocale extends SkillLocaleVoiceDependentLookup[Property]["locales"][number] ?
         never : Property ]: SkillLocaleVoiceDependentLookup[Property]
    }
    :
    keyof {
...
const skillLocaleDependentBuilderMethods = ["emotion","fun","music","longForm"] as const satisfies Readonly<AllBuilderMethods[]>;;
type SkillLocaleDependentBuilderMethods = typeof skillLocaleDependentBuilderMethods[number]
...
type LocaleExclusions<TInclusions extends SkillLocaleDependentBuilderMethods,TVoice extends VoiceNamesOrDefault> = 
TVoice extends Default ? 
Exclude<SkillLocaleDependentBuilderMethods,TInclusions> :
SkillLocaleDependentBuilderMethods


type DependentMethodExclusions<TSkillLocale extends LangLocale,TVoice extends VoiceNamesOrDefault> = 
