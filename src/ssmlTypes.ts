...
//#region sayAs
export type SayAsDateFormat = "mdy" | "dmy" | "ymd" | "md" | "dm" | "ym" | "my" | "d" | "m" | "y"
...
export type AllSpeechcons = LanguageSpeechcons[keyof LanguageSpeechcons][number]

export type LanguageSpeechcon<TSkillLocale extends LangLocale,TVoice extends VoiceNamesOrDefault, TLang extends LangOrDefault>
    = LanguageSpeechcons[LocaleFromLangVoiceOrSkillLocale<TSkillLocale,TVoice,TLang>][number]
//#endregion
...
export type IpaPhonemes = IpaLanguagePhonemes[keyof IpaLanguagePhonemes][number]
...
export type XSampaPhonemes = XSampaLanguagePhonemes[keyof XSampaLanguagePhonemes][number]

// issue with Aditi representing two locales ? should be muti-lingual - todo later use TLocale to reduce
type LocaleFromLangVoiceOrSkillLocale<TSkillLocale extends LangLocale,TVoice extends VoiceNamesOrDefault, TLang extends LangOrDefault> = 
...
export type IpaLangPhoneme<TSkillLocale extends LangLocale,TVoice extends VoiceNamesOrDefault, TLang extends LangOrDefault> = 
    IpaLanguagePhonemes[LocaleFromLangVoiceOrSkillLocale<TSkillLocale,TVoice,TLang>][number]

export type XSampaLangPhoneme<TSkillLocale extends LangLocale,TVoice extends VoiceNamesOrDefault, TLang extends LangOrDefault> = 
    XSampaLanguagePhonemes[LocaleFromLangVoiceOrSkillLocale<TSkillLocale,TVoice,TLang>][number]

//#endregion

// should omit equivalent values ?
export type BreakStrength = "none" | "x-weak"    | "weak" | "medium"/*default*/      | "strong" | "x-strong";

export type EmphasisLevel = "strong" | "moderate" | "reduced";

//#region Prosody
export type ProsodyPredefinedRate = "x-slow" | "slow" | "medium" | "fast" | "x-fast";
export type ProsodyPredefinedPitch = "x-low" | "low" | "medium" | "high" | "x-high";
export type ProsodyPredefinedVolume = "silent" | "x-soft" | "medium" | "loud" | "x-loud";
