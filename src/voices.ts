...
export type VoicesInLocale<TLocale extends LangLocale> =
  VoiceLocales[TLocale][number];

export type LocaleForVoice<TVoice extends AllVoiceNames> = keyof {
  [Property in keyof VoiceLocales as TVoice extends VoiceLocales[Property][number]
    ? Property
    : never]: VoiceLocales[Property];
};
