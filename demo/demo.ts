...
[enUSBuilder, enGBBuilder, esESBuilder].forEach(
  (longFormBuilder) => longFormBuilder.longForm
);
// @ts-expect-error
...
//#region music
[enCABuilder, enGBBuilder, enUSBuilder].forEach(
  (musicBuilder) => musicBuilder.music
);
// @ts-expect-error
jaJpBuilder.music;
// @ts-expect-error
...
// #region emotion
[jaJpBuilder, deDEBuilder, enGBBuilder, enUSBuilder].forEach(
  (emotionBuilder) => emotionBuilder.emotion
);
// @ts-expect-error
enAUBuilder.emotion;
// @ts-expect-error
...
[enUSBuilder, itITBuilder, jaJpBuilder].forEach(
  (conversationalBuilder) => conversationalBuilder.conversational
);
// @ts-expect-error
